...
from utils.tool_conversation import Conversation, get_conv_template
from utils.compression import load_compress_model
...
class LlamaAgentAdapter(BaseAdapter):
    "Model adapater for tool-llama"

    def match(self, model_path: str):
        return "collab_agent_v1" in model_path
    ...
    def get_default_conv_template(self, model_path: str) -> Conversation:
        return get_conv_template("collab_agent_v1")


class LlamaAgentAdapterV3(BaseAdapter):
    "Model adapater for tool-llama"

    def match(self, model_path: str):
        return "collab_agent_v3" in model_path
    ...
    def get_default_conv_template(self, model_path: str) -> Conversation:
        return get_conv_template("collab_agent_v3")

# Note: the registration order matters.
# The one registered earlier has a higher matching priority.
register_model_adapter(VicunaAdapter)
register_model_adapter(ToolLlamaAdapter)
register_model_adapter(LlamaAgentAdapter)
register_model_adapter(LlamaAgentAdapterV3)
